---
{"dg-publish":true,"permalink":"/cisco/ccna-definitions-vault-main/20-definitions/stp/","tags":["defs_ccna"]}
---
...
3.  [[CISCO/ccna-definitions-vault-main/20 - Definitions/IEEE\|IEEE]] Open Standards:
	...
	2.  **802.1w** [[CISCO/ccna-definitions-vault-main/20 - Definitions/Rapid STP\|Rapid STP]] (RSTP)
...
4.  Cisco Versions
	1.  Cisco released enhancements to the open standards
		1.  **Per VLAN Spanning Tree Plus (PVST+)**
			...
			3.  *PVST+* is the *default* on Cisco [[CISCO/ccna-definitions-vault-main/20 - Definitions/Switch\|Switches]]
	...
	2.  The Cisco versions do not support grouping multiple [[CISCO/ccna-definitions-vault-main/20 - Definitions/VLAN\|VLANs]] into the same instance
5. Misc
	1. *MAC Flapping* or *MAC Address Flapping* is when the same MAC address is active on two ports within a network.
		...
		2. This is almost always an indication of a loop in the network, but could also be an attacker on the network
			1. Attacks include CAM table poisoning, [[CISCO/ccna-definitions-vault-main/20 - Definitions/Layer 2 Attack Types\|MAC spoofing]], etc.

### STP Cost
(table from [PacketLife.net](https://packetlife.net/blog/2008/sep/5/spanning-tree-port-costs/))
![[STP-Costs-1.png\|STP-Costs-1.png]]
...
4.  Determine the Root Ports on the other [[CISCO/ccna-definitions-vault-main/20 - Definitions/Switch\|switches]]
...
#### Problem
![[STP-Example-1.png\|STP-Example-1.png]]
#### Solution
![[STP-Example-Solution.png\|STP-Example-Solution.png]]
