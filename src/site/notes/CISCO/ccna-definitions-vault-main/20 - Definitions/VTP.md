---
{"dg-publish":true,"permalink":"/cisco/ccna-definitions-vault-main/20-definitions/vtp/","tags":["defs_ccna"]}
---

#### VTP
- *VLAN Trunking Protocol (VTP)* allows you to add, edit, or delete [[CISCO/ccna-definitions-vault-main/20 - Definitions/VLAN\|VLANs]] on [[CISCO/ccna-definitions-vault-main/20 - Definitions/Switch\|switches]] configured as VTP servers, and have other [[CISCO/ccna-definitions-vault-main/20 - Definitions/Switch\|switches]] configured as VTP clients synchronize their VLAN database with them
...
### VTP Modes
1. VTP Server
	1. Can add, edit, or delete [[CISCO/ccna-definitions-vault-main/20 - Definitions/VLAN\|VLANs]]
	2. A VTP server will synchronize its VLAN databvase from another VTP Server with a higher revision number
2. VTP Client
	1. Cannot add, edit, or delete [[CISCO/ccna-definitions-vault-main/20 - Definitions/VLAN\|VLANs]]
...
3. VTP Transparent
	...
	3. Can add, edit, or delete [[CISCO/ccna-definitions-vault-main/20 - Definitions/VLAN\|VLANs]] in its own local VLAN database
#### VTP Mode Chart
