---
{"dg-publish":true,"permalink":"/cisco/ccna-definitions-vault-main/20-definitions/tcp/","tags":["defs_ccna"]}
---

## TCP
### TCP Summary
*Transmission Control Protocol* is a [[CISCO/ccna-definitions-vault-main/20 - Definitions/21 - OSI Layers/Layer 4\|L4]] connection-oriented protocol
1. Connection oriented
	1. Before transmitting data, two hosts establish a connection
2. Reliable communication
	1. Destination host *MUST* send an acknowledge that it received each TCP [[CISCO/ccna-definitions-vault-main/20 - Definitions/Segment\|Segment]]
...
4. Provides [[CISCO/ccna-definitions-vault-main/20 - Definitions/Flow Control\|Flow Control]]
...
#### TCP Header
![[TCP-header-2.png\|TCP-header-2.png]]
...
3. There are a series of flags in the *12th octet* that are used (when set to 1, they are active)
	1. Flags used to establish/terminate connections
		...
		2. SYN
		3. FIN
4. *Window Size* is used for [[CISCO/ccna-definitions-vault-main/20 - Definitions/Flow Control\|Flow Control]]
...
### Common Protocols
Port 21, [[FTP\|FTP]]
Port 22, [[CISCO/ccna-definitions-vault-main/20 - Definitions/SSH\|SSH]]
Port 23, [[CISCO/ccna-definitions-vault-main/20 - Definitions/Telnet\|Telnet]]
Port 53, [[CISCO/ccna-definitions-vault-main/20 - Definitions/DNS\|DNS]]
Port 80, [[CISCO/ccna-definitions-vault-main/20 - Definitions/HTTP\|HTTP]]
Port 443, [[CISCO/ccna-definitions-vault-main/20 - Definitions/HTTP\|HTTPS]]
