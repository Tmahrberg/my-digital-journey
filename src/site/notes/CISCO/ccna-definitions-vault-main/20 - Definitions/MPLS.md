---
{"dg-publish":true,"permalink":"/cisco/ccna-definitions-vault-main/20-definitions/mpls/","tags":["defs_ccna"]}
---
...
- *Multiprotocol Label Switching* is a routing technique in telecommunications networks that directs data from one node to the next based on **labels** rather than network addresses.
	...
	- *Label switching* allows service providers to create [[CISCO/ccna-definitions-vault-main/20 - Definitions/VPN\|VPNs]] for clients over their shared infrastructure
- **Core Infrastructure**
	...
	- *PE router* (Provider Edge router)
		...
		- When *PE* routers receive frames *CE* router, they add a label between the *[[CISCO/ccna-definitions-vault-main/20 - Definitions/21 - OSI Layers/Layer 2\|Layer 2]]* and *[[CISCO/ccna-definitions-vault-main/20 - Definitions/21 - OSI Layers/Layer 3\|Layer 3]]* headers
