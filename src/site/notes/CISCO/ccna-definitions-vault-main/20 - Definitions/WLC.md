---
{"dg-publish":true,"permalink":"/cisco/ccna-definitions-vault-main/20-definitions/wlc/","tags":["defs_ccna"]}
---

#### WLC
*Wireless LAN Controller*; Used in combination with the [[CISCO/ccna-definitions-vault-main/20 - Definitions/CAPWAP\|CAPWAP (Control and Provisioning of Wireless Access Points)]] to manage [[CISCO/ccna-definitions-vault-main/20 - Definitions/Wireless Access Points\|Lightweight Access Points]] in large quantities by the network administrator or network operations center. 
...
![[WLC-Ports-Interfaces-1.png\|WLC-Ports-Interfaces-1.png]]
...
2. *Distribution Port*
	1. Standard network ports that connect to the [[CISCO/ccna-definitions-vault-main/20 - Definitions/Distribution System (DS)\|Distribution System (DS)]]
		1. Used for Data Traffic
	2. Usually connect to switch Trunk ports
	3. If there's more than one, they all form a [[CISCO/ccna-definitions-vault-main/20 - Definitions/EtherChannel\|LAG]] by default
3. *Console Port*
	1. For direct management; either RJ45 or USB
4. *Redundancy Port*
	1. Used to physically connect another *WLC* in an [[CISCO/ccna-definitions-vault-main/20 - Definitions/High Availability\|HA Pair]]

### WLC Interfaces
1. *Management Interface*
	1. Used for management traffic, such as SSH, RADIUS, Syslog, HTTPS, etc.
	2. [[CISCO/ccna-definitions-vault-main/20 - Definitions/CAPWAP\|CAPWAP]] tunnels are also formed with this interface
2. *Redundancy Management Interface*
	1. Used to manage the "standby" WLC in an [[CISCO/ccna-definitions-vault-main/20 - Definitions/High Availability\|HA Pair]]
3. *Virtual Interface*
	1. Two key roles:
...
6. *AP Manager Interface*
	1. Used for all [[CISCO/ccna-definitions-vault-main/20 - Definitions/21 - OSI Layers/Layer 3\|Layer 3]] communications between the *WLC* and *Lightweight APs* after they have joined the controller
...
2. *Controller Tab*
	1. Create and control interfaces
		1. Assign netmask, gateway, DHCP server, [[CISCO/ccna-definitions-vault-main/20 - Definitions/ACL\|ACLs]], etc.
...
3. *WLAN Tab*
	...
	2. *WLAN Editor Subtab*
		...
		2. *Security Subtab*
			1. Allows you to configure [[CISCO/ccna-definitions-vault-main/20 - Definitions/21 - OSI Layers/Layer 2\|Layer 2]] security settings
				1. Remember: *PSK* = **Personal**, *[[CISCO/ccna-definitions-vault-main/20 - Definitions/802.1X\|802.1X]]* = **Enterprise**
				2. PSK can be either [[CISCO/ccna-definitions-vault-main/20 - Definitions/ASCII\|ASCII]] or [[CISCO/ccna-definitions-vault-main/20 - Definitions/bits\|Hexadecimal]]
		3. *QoS Subtab*
			1. Choose the default QoS for that VLAN
				...
				4. *Bronze* = Background
		4. *Advanced Subtab*
			1. [[CISCO/ccna-definitions-vault-main/20 - Definitions/FlexConnect\|FlexConnect]], maximum number of clients, etc.
4. *Wireless Tab*
	...
	2. Also set AP operational mode
		...
		7. SE-Connect
5. *Management Tab*
	1. Change management connection settings like [[CISCO/ccna-definitions-vault-main/20 - Definitions/SSH\|SSH]], [[CISCO/ccna-definitions-vault-main/20 - Definitions/SNMP\|SNMP]], [[CISCO/ccna-definitions-vault-main/20 - Definitions/HTTP\|HTTPS]], etc.
	2. Can also enable wireless clients to manage WLC
6. *Security Tab*
	1. Create and manage [[CISCO/ccna-definitions-vault-main/20 - Definitions/ACL\|ACLs]], [[CISCO/ccna-definitions-vault-main/20 - Definitions/EAP\|EAP]], [[RADIUS\|RADIUS]]/[[TACACS+\|TACACS+]] config, etc.
