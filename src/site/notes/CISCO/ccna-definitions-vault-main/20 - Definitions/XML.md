---
{"dg-publish":true,"permalink":"/cisco/ccna-definitions-vault-main/20-definitions/xml/","tags":["defs_ccna"]}
---
...
2. XML is now used as a general data serialization language
	...
	3. Often used in [[CISCO/ccna-definitions-vault-main/20 - Definitions/REST\|REST APIs]], same as [[CISCO/ccna-definitions-vault-main/20 - Definitions/JSON\|JSON]]
###### XML Sample
```XML
<IPInterfaces>
	<entry>
