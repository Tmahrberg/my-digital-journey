---
{"dg-publish":true,"permalink":"/cisco/ccna-definitions-vault-main/20-definitions/i-pv4-address-classes/","tags":["defs_ccna"]}
---

#### IPv4 Address Classes
- There are 5 IPv4 *Address Classes* defined by **RFC 1918**, each allocated to a specific purpose or consumer.
	- NOTE: While occasionally referenced in the **CCNA**, they are not relevant when it comes to [[CISCO/ccna-definitions-vault-main/20 - Definitions/IP subnet\|subnetting]]
